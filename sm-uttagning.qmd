...
Så här långt har fyra tävlingar fäktats -- Uppsala Cup, SAF-pokalen, Kupittaa tournament och Bernadotte. Samtliga dessa hade såväl dam- som herrklass. Låt oss se på poänglistorna.

### Aktuell ställning för damer

På damsidan är det Sophie som börjat detta fäktår starkt och plockat flest poäng. Efter henne har vi Louise och Linnea som också imponerat starkt.
