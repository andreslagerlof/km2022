...
Efter tre genomförda tävlingar -- Uppsala Cup, SAF-pokalen, Kupittaa Tournament -- varav de sista två var satellite VC har vi för närvarande följande totalsammanställning.

### Aktuell ställning för damer

Vi ser att Sophie har tagit ett stabilt grepp över poänglistan följd av Louise och därefter Linea som med knappast möjliga marginal placerar sig före Pia.
